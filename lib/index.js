...
function applyDecorators(Class, props) {
  ...
  if (!isObject$2(props)) throw new TypeError('applyDecorators only accept object as second arguments');
...
var Base = function () {
  ...
  _createClass(Base, [{
    ...
    value: function createEl() {
      ...
      typeof this.option.html === 'string' ? this.$dom.innerHTML = this.option.html : this.$dom.appendChild(this.option.html);
...
var Clarity = function (_Base) {
  ...
  _createClass(Clarity, [{
    ...
    value: function init() {
      ...
      if (!list.length) {
        return chimeeHelper.setStyle(this.$dom, {
          display: 'none'
        });
      }
    ...
    key: 'initTextList',
    value: function initTextList(list) {
      var _this2 = this;
    ...
    value: function switchClarity(url) {
      ...
      var _option = this.option,
          ...
          bias = _option.bias,
          increment = _option.increment,
          repeatTimes = _option.repeatTimes,
          immediate = _option.immediate,
          abort = _option.abort;
...
var Playbackrate = function (_Base) {
  _inherits(Playbackrate, _Base);

  function Playbackrate(parent, option) {
    _classCallCheck(this, Playbackrate);

    var _this = _possibleConstructorReturn(this, (Playbackrate.__proto__ || _Object$getPrototypeOf(Playbackrate)).call(this, parent));

    _this.option = chimeeHelper.deepAssign(defaultOption$6, chimeeHelper.isObject(option) ? option : {});
    _this.init();
    return _this;
  }
  ...
  _createClass(Playbackrate, [{
    key: 'init',
    value: function init() {
      _get(Playbackrate.prototype.__proto__ || _Object$getPrototypeOf(Playbackrate.prototype), 'create', this).call(this);
      chimeeHelper.addClassName(this.$dom, 'chimee-flex-component');

      this.$text = chimeeHelper.$(this.$dom).find('chimee-playbackrate-text');
      this.$list = chimeeHelper.$(this.$dom).find('chimee-playbackrate-list');
      this.$listUl = this.$list.find('ul');
    ...
    value: function initTextList() {
      ...
      var length = this.option.list.length;
      var hasRenderDefault = false;
      this.option.list.forEach(function (item, i) {
        var li = chimeeHelper.$(document.createElement('li'));
        ...
        if (item.default || !hasRenderDefault && i === length - 1) {
          ...
          _this2.$text.text(item.name);
          li.addClass('active');
          _this2.switchPlaybackrate(item.value);
        }
        _this2.$listUl.append(li);
      });
    }
    ...
    value: function click(e) {
      var elem = e.target;
      if (elem.tagName === 'LI') {
        var rate = elem.getAttribute('data-value') || 1;
    ...
    key: 'switchPlaybackrate',
    value: function switchPlaybackrate(rate) {
      var _this3 = this;

      setTimeout(function (_) {
        _this3.parent.playbackRate = rate;
      }, 0);
    }
  }]);
...
var chimeeControl = {
  ...
  methods: {
    ...
    updateClarity: function updateClarity(list) {
      if (!isArray$1(list)) {
