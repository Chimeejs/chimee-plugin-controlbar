...
/**
 * chimee-plugin-controlbar v0.0.9
 * (c) 2017 yandeqiang
 * Released under ISC
 */
...
var ProgressBar = (_class$1 = function (_Base) {
  ...
  return ProgressBar;
}(Base), (_applyDecoratedDescriptor$1(_class$1.prototype, 'screenChange', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'screenChange'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'mousedown', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'mousedown'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'draging', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'draging'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'dragEnd', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'dragEnd'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'mouseenter', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'mouseenter'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'tipShow', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'tipShow'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'tipEnd', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'tipEnd'), _class$1.prototype)), _class$1);
...
if (document.webkitCancelFullScreen) {
  screenEvent$1 = 'webkitfullscreenchange';
  currentScreenElement = 'webkitFullscreenElement';
} else if (document.mozCancelFullScreen) {
  screenEvent$1 = 'mozfullscreenchange';
  currentScreenElement = 'mozFullScreenElement';
} else if (document.msExitFullscreen) {
  screenEvent$1 = 'msfullscreenchange';
  currentScreenElement = 'msFullscreenElement';
} else if (document.exitFullscreen) {
  screenEvent$1 = 'fullscreenchange';
...
var Screen = (_class$2 = function (_Base) {
  ...
  _createClass(Screen, [{
    ...
    value: function click() {
      ...
      if (full) {
        chimeeHelper.addEvent(document, screenEvent$1, this.screenChange);
      } else {
        chimeeHelper.removeEvent(document, screenEvent$1, this.screenChange);
      }
    }
  }, {
    key: 'screenChange',
  ...
  _createClass(Clarity, [{
    ...
    value: function click(e) {
      ...
      if (elem.tagName === 'LI') {
        ...
        this.parent.load(url).then(function () {
