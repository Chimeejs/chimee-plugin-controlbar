...
var Volume = (_class = function (_Base) {
  ...
  _createClass(Volume, [{
    ...
    value: function init() {
      ...
      this.$ball = chimeeHelper.$('chimee-volume-bar-ball', this.$dom);
      chimeeHelper.addClassName(this.$dom, 'chimee-component');
      this.changeState();
      // 用户自定义配置
      this.option.width && chimeeHelper.setStyle(this.$dom, 'width', this.option.width);
    ...
    value: function mousedown(e) {
      var ballRect = this.$ball[0].getClientRects()[0];
...
var ProgressBar = (_class$1 = function (_Base) {
  ...
  return ProgressBar;
}(Base), (_applyDecoratedDescriptor$1(_class$1.prototype, 'mousedown', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'mousedown'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'draging', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'draging'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'dragEnd', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'dragEnd'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'mouseenter', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'mouseenter'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'tipShow', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'tipShow'), _class$1.prototype), _applyDecoratedDescriptor$1(_class$1.prototype, 'tipEnd', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class$1.prototype, 'tipEnd'), _class$1.prototype)), _class$1);
