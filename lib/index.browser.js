...
var Screen = (_class$2 = function (_Base) {
  ...
  _createClass(Screen, [{
    ...
    value: function click() {
      ...
      if (full) {
        addEvent(document, screenEvent$1, this.screenChange);
      } else {
        removeEvent(document, screenEvent$1, this.screenChange);
      }
    }
  }, {
    key: 'screenChange',
