...
const testFunctions = Object.assign(Object.create(null), {
  ...
  test: true }); /**
                  ...
                  *
                  * 
                  */const matchesTestFunction = object => object && testFunctions[object.name];const isCallToSkippedTestFunction = object => object && object.name[0] === 'x' && testFunctions[object.name.substring(1)];const isPropertyNamedSkip = property =>
