 ...
 */
function genTraversalHandler$1(fn) {
  function recursiveFn(source, target, key) {
    if (isArray$1(source) || isObject$1(source)) {
      target = target || (isObject$1(source) ? {} : []);
      for (var _key in source) {
...
var _deepAssign$1 = genTraversalHandler$1(function (val) {
  return val;
});
/**
...
function deepAssign$1() {
  ...
  args.forEach(function (source) {
    return _deepAssign$1(source, target);
  });
  return target;
}
...
var Play = function (_Base) {
  ...
  function Play(parent, option) {
    ...
    _this.option = deepAssign$1(defaultOption, isObject$1(option) ? option : {});
    _this.init();
    return _this;
  }
...
var Volume = (_class = function (_Base) {
  ...
  function Volume(parent, option) {
    ...
    _this.option = deepAssign$1(defaultOption$1, isObject$1(option) ? option : {});
    _this.init();
    return _this;
  }
...
var ProgressBar = (_class$1 = function (_Base) {
  ...
  function ProgressBar(parent, option) {
    ...
    _this.option = deepAssign$1(defaultOption$2, isObject$1(option) ? option : {});
...
var ProgressTime = function (_Base) {
  ...
  function ProgressTime(parent, option) {
    ...
    _this.option = deepAssign$1(defaultOption$3, isObject$1(option) ? option : {});
    _this.init();
    return _this;
  }
...
var Screen = (_class$2 = function (_Base) {
  ...
  function Screen(parent, option) {
    ...
    _this.state = 'small';
    _this.option = deepAssign$1(defaultOption$4, isObject$1(option) ? option : {});
    _this.init();
    return _this;
  }
...
var chimeeControl = {
  ...
  init: function init(videoConfig) {
    ...
    this.config = isObject$1(this.$config) ? deepAssign$1(defaultConfig, this.$config) : defaultConfig;
